...
namespace Anilibria.Controls {
	...
	public sealed partial class HumburgerIcon : UserControl {
		public HumburgerIcon () => InitializeComponent ();

		public static readonly DependencyProperty IconWidthProperty =
					DependencyProperty.Register (
						"IconWidth" ,
						typeof ( double ) ,
						typeof ( HumburgerIcon ) ,
		...
		private static void IconWidthChangedHandler ( DependencyObject d , DependencyPropertyChangedEventArgs e ) {
			if ( !( d is HumburgerIcon iconControl ) ) return;
